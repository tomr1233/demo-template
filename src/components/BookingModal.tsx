  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        <div className="bg-gradient-to-br from-slate-50/95 to-blue-50/95 backdrop-blur-xl 
                        rounded-2xl shadow-2xl border border-blue-200/30">
          
          {/* Close Button - Positioned absolutely with better spacing */}
          <button
            onClick={onClose}
            className="absolute top-6 right-6 z-10 p-2 rounded-lg bg-slate-200/50 hover:bg-slate-300/50 
                       border border-slate-300/50 hover:border-slate-400/50 
          ...
          <form onSubmit={handleSubmit} className="pt-16 px-6 pb-6 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <label className="block text-sm font-mono font-medium text-slate-700">
                  Full Name
                </label>
                <input
                  type="text"
            ...
            <div className="space-y-6">
              <h3 className="text-lg font-mono font-semibold text-slate-800 flex items-center space-x-2">
                <Clock className="w-5 h-5 text-blue-700" />
                <span>Select Time</span>
              </h3>
              
              <div className="bg-white/50 rounded-xl p-6 border border-slate-200/50">
                <TimeSlotSelector
